...
*
*@package  ragingpixel\CollapsibleContent\Shortcode
*
*@since 1.0.0
*
...
*
*
*@link www.ragingpixel.com.au
*
*@license GNU-2.0+
*
*/
namespace ragingpixel\CollapsibleContent\Shortcode;

//[qa question="What question would you like to ask me?" show_icon="" hide_icon=""]This is the answer[/qa]

//[teaser visable_message="What question would you like to ask me?" show_icon=""]This is the answer[/teaser]
...
*@sice 1.0.0
*
*@param array|string $user_defined_attributes User defined attributes for this shourtcode instance
